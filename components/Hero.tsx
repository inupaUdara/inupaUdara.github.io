...
const Hero = () => {
  ...
  return (
    <div className="pb-20 pt-20 sm:h-screen w-full relative flex items-center justify-center">
      ...
      <div className="h-screen w-full dark:bg-stone-950 bg-white  dark:bg-grid-white/[0.02] bg-grid-black/[0.2] flex items-center justify-center absolute top-0 left-0">
